 ...
 */
func (a CharacterApi) GetCharactersCharacterIdCorporationhistory(characterId int32, datasource string) ([]GetCharactersCharacterIdCorporationhistory200OkObject, *APIResponse, error) {
 ...
 */
func (a CharacterApi) GetCharactersNames(characterIds []int64, datasource string) ([]GetCharactersNames200OkObject, *APIResponse, error) {
