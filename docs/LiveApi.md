...
# **GetAlliancesNames**
> []GetAlliancesNames200OkObject GetAlliancesNames($allianceIds, $datasource)
...
[**[]GetAlliancesNames200OkObject**](get_alliances_names_200_ok_object.md)
...
> []GetCharactersCharacterIdBookmarks200OkObject GetCharactersCharacterIdBookmarks($characterId, $datasource)
...
[**[]GetCharactersCharacterIdBookmarks200OkObject**](get_characters_character_id_bookmarks__200_ok_object.md)
...
> []GetCharactersCharacterIdBookmarksFolders200OkObject GetCharactersCharacterIdBookmarksFolders($characterId, $datasource)
...
[**[]GetCharactersCharacterIdBookmarksFolders200OkObject**](get_characters_character_id_bookmarks_folders__200_ok_object.md)
...
> []GetCharactersCharacterIdMail200OkObject GetCharactersCharacterIdMail($characterId, $labels, $lastMailId, $datasource)
...
[**[]GetCharactersCharacterIdMail200OkObject**](get_characters_character_id_mail_200_ok_object.md)
...
> []GetCharactersCharacterIdMailLists200OkObject GetCharactersCharacterIdMailLists($characterId, $datasource)
...
[**[]GetCharactersCharacterIdMailLists200OkObject**](get_characters_character_id_mail_lists_200_ok_object.md)
...
> []GetCharactersCharacterIdSkillqueue200OkObject GetCharactersCharacterIdSkillqueue($characterId, $datasource)
...
[**[]GetCharactersCharacterIdSkillqueue200OkObject**](get_characters_character_id_skillqueue_200_ok_object.md)
...
# **PostUniverseNames**
> []PostUniverseNames200OkObject PostUniverseNames($ids, $datasource)
...
[**[]PostUniverseNames200OkObject**](post_universe_names_200_ok_object.md)
