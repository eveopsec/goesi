 ...
 */
func (a CalendarApi) GetCharactersCharacterIdCalendar(characterId int64, fromEvent int32, datasource string) ([]GetCharactersCharacterIdCalendar200OkObject, *APIResponse, error) {
